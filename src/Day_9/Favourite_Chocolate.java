...
public class Favourite_Chocolate {
    public int calculate_Favourite_Chocolate(int A, int B, int C){
        int money = A;
        int costOfChocolate = B;
        int limitOfChocolate = C;

        int result = money/costOfChocolate;

        if(result >= limitOfChocolate){
            return limitOfChocolate;
        }else{
            return result;
        }
    }
    public void favourite_Chocolate(){
        ...
        int value = calculate_Favourite_Chocolate(a,b,c);
